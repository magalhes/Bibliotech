  ...
  function onSubmit(data) {
   const {email,senha} = data;
    loginEmailSenha(email,senha).then((user)=>{
        toast.success(`Entrando como ${user.email}`,{position:"bottom-right", duration:2500})
        navigate("/");
    }).catch((erro)=>{
        toast.error(`Um erro aconteceu . Codigo${erro.code}`, {position:"bottom-right", duration:2500})
    })
  }
